...
class CalculatorViewModel: ViewModel() {
    ...
    fun onAction(action: CalculatorAction){
        when(action){
            ...
            is CalculatorAction.Operation -> enterOpration(action.operation)
    ...
    private fun performCalculation() {
        ...
        if (number1 != null && number2 != null){
            val result = when(state.operation){
                ...
                is CalculationOperation.Substract -> number1 - number2
            ...
            state = state.copy(
                number1 = formattedResult.toString().take(15),
                number2 = "",
                operation = null
            )
        }
    ...
    private fun enterOpration(operation: CalculationOperation) {
